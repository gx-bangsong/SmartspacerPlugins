...
class TravelSettingsRepositoryImpl(context: Context) : BaseSettingsRepositoryImpl(), TravelSettingsRepository {
    ...
    private val _jumpTarget = MutableStateFlow(sharedPreferences.getString(KEY_JUMP_TARGET, "none") ?: "none")
    ...
    init {
        sharedPreferences.registerOnSharedPreferenceChangeListener { prefs, key ->
            when (key) {
                ...
                KEY_JUMP_TARGET -> _jumpTarget.value = prefs.getString(KEY_JUMP_TARGET, "none") ?: "none"
            }
        }
    }
